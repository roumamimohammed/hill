            ...
            <div class="col-8 mx-auto">
                ...
                <form class="p-5 border mb-5" method="POST" action="<?php url('products/update'); ?>">
                    <div class="form-group">
                        ...
                        <input type="text" required value="<?php echo $row['label']; ?>" name="name" class="form-control" id="name" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" required class="form-control" value="<?php echo $row['quantity']; ?>" name="qty" id="qty">
                    </div>
